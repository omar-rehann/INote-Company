...
console.log(form.children[2].children[2].children[0].textContent);

let footer = document.querySelector(".footer");
form.children[2].children[2].children[0].innerHTML = '<i class="fas fa-phone"></i> <strong>اتصل بنا:</strong> <a href="tel:+201234567890">+20 123 456 7890</a>';
form.children[2].children[2].children[1].innerHTML = '<i class="fas fa-envelope"></i> <strong>راسلنا عبر البريد:</strong> <a href="mailto:info@inotetech.com">info@inotetech.com</a>';
form.children[2].children[2].children[2].innerHTML = '<i class="fas fa-comments"></i> <strong>الدردشة المباشرة:</strong> <a href="#livechat">ابدأ المحادثة الآن</a>';
form.children[2].children[2].children[3].innerHTML = '<i class="fas fa-file-signature"></i> <strong>نموذج الطلب:</strong> <a href="#quote-form">طلب عرض سعر</a>';
form.children[2].children[2].children[4].innerHTML = '<i class="fas fa-map-marker-alt"></i> <strong>موقعنا:</strong> Port Said, Egypt';
...
langauage.addEventListener("change", function() {
    ...
    if (langauage_select === "Arabic") {
        ...
        text_background[0].textContent = "طلب عرض السعر | اي نوت تك";
        ...
        // start form 
        form.children[0].children[0].textContent = "   يمكنك التواصل معنا عن طريق:";
        form.children[0].children[1].textContent = "يرجى ملء النموذج بالمعلومات الأساسية حول نشاطك التجاري واحتياجاتك.";
        form.children[1].children[0].textContent = "نحن هنا للإجابة على استفساراتك ومساعدتك في اختيار الحل الأنسب لنجاح مشروعك.";
        form.children[1].children[1].textContent = "   سيتواصل معك أحد خبرائنا لفهم أهدافك واقتراح أفضل الحلول التقنية المصممة خصيصًا لاحتياجات نشاطك التجاري.";
        form.children[2].children[0].textContent = "نحن هنا للإجابة على استفساراتك ومساعدتك في اختيار الحل الأنسب لنجاح مشروعك.";
        form.children[2].children[1].textContent = "  سيتواصل معك أحد خبرائنا لفهم أهدافك واقتراح أفضل الحلول التقنية المصممة خصيصًا لاحتياجات نشاطك التجاري.";
        form.children[2].children[2].children[0].innerHTML = '<i class="fas fa-phone"></i> <strong>اتصل بنا:</strong> <a href="tel:+201234567890">+20 123 456 7890</a>';
        form.children[2].children[2].children[1].innerHTML = '<i class="fas fa-envelope"></i> <strong>راسلنا عبر البريد:</strong> <a href="mailto:info@inotetech.com">info@inotetech.com</a>';
        form.children[2].children[2].children[2].innerHTML = '<i class="fas fa-comments"></i> <strong>الدردشة المباشرة:</strong> <a href="#livechat">ابدأ المحادثة الآن</a>';
        form.children[2].children[2].children[3].innerHTML = '<i class="fas fa-file-signature"></i> <strong>نموذج الطلب:</strong> <a href="#quote-form">طلب عرض سعر</a>';
        ...
        text_background[0].textContent = "Request a Quote | iNote Tech";
        text_background[1].textContent = "Topics that inspire you and keep pace with the latest trends in technology, design, and digital marketing."; // start boxes
        ...
        // start form 
        form.children[0].children[0].textContent = "You can reach out to us through:";
        form.children[0].children[1].textContent = "Please fill out the form with basic information about your business and needs.";

        form.children[1].children[0].textContent = "We're here to answer your questions and help you choose the best solution for your project's success.";
        form.children[1].children[1].textContent = "One of our experts will contact you to understand your goals and recommend the best tech solutions tailored to your business.";

        form.children[2].children[0].textContent = "We're here to answer your questions and help you choose the best solution for your project's success.";
        form.children[2].children[1].textContent = "One of our experts will contact you to understand your goals and recommend the best tech solutions tailored to your business.";
        form.children[2].children[2].children[0].innerHTML = '<i class="fas fa-phone"></i> <strong>Call us:</strong> <a href="tel:+201234567890">+20 123 456 7890</a>';
        form.children[2].children[2].children[1].innerHTML = '<i class="fas fa-envelope"></i> <strong>Email us:</strong> <a href="mailto:info@inotetech.com">info@inotetech.com</a>';
        form.children[2].children[2].children[2].innerHTML = '<i class="fas fa-comments"></i> <strong>Live chat:</strong> <a href="#livechat">Start a conversation</a>';
        form.children[2].children[2].children[3].innerHTML = '<i class="fas fa-file-signature"></i> <strong>Quote request:</strong> <a href="#quote-form">Request a quote</a>';
        form.children[2].children[2].children[4].innerHTML = '<i class="fas fa-map-marker-alt"></i> <strong>Location:</strong> Port Said, Egypt';
